...
namespace CarvedRock.DataAccess.Migrations
{
    ...
    [Migration("20221212123313_Table-per-Type")]
            ...
            modelBuilder.Entity("CarvedRock.DataAccess.Models.CannedFoodItem", b =>
                {
                    b.HasOne("CarvedRock.DataAccess.Models.Item", null)
                        .WithOne()
                        .HasForeignKey("CarvedRock.DataAccess.Models.CannedFoodItem", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CarvedRock.DataAccess.Models.ClothesItem", b =>
                {
                    b.HasOne("CarvedRock.DataAccess.Models.Item", null)
                        .WithOne()
                        .HasForeignKey("CarvedRock.DataAccess.Models.ClothesItem", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CarvedRock.DataAccess.Models.DriedFoodItem", b =>
                {
                    b.HasOne("CarvedRock.DataAccess.Models.Item", null)
                        .WithOne()
                        .HasForeignKey("CarvedRock.DataAccess.Models.DriedFoodItem", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CarvedRock.DataAccess.Models.MagazineItem", b =>
                {
                    b.HasOne("CarvedRock.DataAccess.Models.Item", null)
                        .WithOne()
                        .HasForeignKey("CarvedRock.DataAccess.Models.MagazineItem", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
